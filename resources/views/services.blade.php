...
<head>
    <meta charset="utf-8">
    <title>Dienstleistungen - Miosk</title>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="ph-20 feature-box text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
                            <span class="icon large default-bg circle"><i class="fa fa-truck"></i></span>
                            <h3>Liefern</h3>
                            <div class="separator clearfix"></div>
                            <p class="text-muted">Wenn Sie auf der Wache sind können Sie bequem Bestellungen aufgeben welche dann ins Wachlokal geliefert werden. Die Lieferung erfolgt so schnell wie möglich.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="ph-20 feature-box text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="200">
                            <span class="icon large dark-bg circle"><i class="fa fa-shopping-bag"></i></span>
                            <h3>Abholen</h3>
                            <div class="separator clearfix"></div>
                            <p class="text-muted">Sie können Bestellungen aufgeben und diese dann in der Unterkunft im zweiten Stock beim Eingang zum Kaderbereich abholen. Abholtermine: 12:30 Uhr oder 18:30 Uhr.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="ph-20 feature-box text-center object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="200">
                            <span class="icon large default-bg circle"><i class="icon-comment"></i></span>
                            <h3>Feedback</h3>
                            <div class="separator clearfix"></div>
                            <p class="text-muted">Als registrierter Benutzer können Sie direkten Kontakt aufnehmen. Haben Sie Fragen, Verbesserungsvorschläge oder sonstiges Feedback, dann melden Sie sich.</p>
                        </div>
                    </div>
                </div>
